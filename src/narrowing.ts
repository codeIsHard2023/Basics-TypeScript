...
// Example 1
function exeample1Instanceof(arr: string | string[]) {
...
// Example 2
function exeample2Instanceof(a: string | Date) {
...
function isDate(a: Date): a is Date {
  return a instanceof Date;
}
// console.log(isDate(today));
/****************************************** */

function checkUnion(a: string | number, b: boolean | string) {
  if (a === b) {
    return (
      a.toUpperCase() +
      " and " +
